...
```{r treatment_selection_strategy, eval=TRUE, echo=FALSE, results="asis", message=FALSE, warning = FALSE, fig.path = "Figures/", fig.width = 9, fig.height = 3}
...
```{r tnc_partitioning_wtc4, eval=TRUE, echo=FALSE, results="asis", message=FALSE, warning = FALSE, fig.path = "Figures/", fig.width = 9, fig.height = 14}
source('R/tnc_partitioning_wtc4.R')
```

<!-- write the file of TNC partitioning from WTC-4 dataset  -->
```{r tnc_partitioning_data, eval=TRUE, echo=FALSE, results="asis", message=FALSE, warning = FALSE}
...
```{r GPP_Ra_LA_data, eval=TRUE, echo=FALSE, results="asis", message=FALSE, warning = FALSE, fig.path = "Figures/", fig.width = 9, fig.height = 6}
...
```{r stem_height_diameter_data, eval=TRUE, echo=FALSE, results="asis", message=FALSE, warning = FALSE}
source('R/stem_height_diameter_data.R')
```

<!-- Get the root mass (initial - estimated and final - harvested) for each treatment  -->
```{r rootmass_data, eval=TRUE, echo=FALSE, results="asis", message=FALSE, warning = FALSE}
source('R/rootmass_data.R')
```

<!-- Get an estimate of branch, stem, and leaf mass as well as leaf area for each treatment  -->
```{r branch_stem_leafmass_data, eval=TRUE, echo=FALSE, results="asis", message=FALSE, warning = FALSE}
...
```{r plot_biomass_data, eval=TRUE, echo=FALSE, results="hide", collapse = TRUE, message=FALSE, warning = FALSE, fig.path = "Figures/", fig.width = 9, fig.height = 9}
